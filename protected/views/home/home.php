<script type="text/javascript">
  var flashvars = {};
  flashvars.cssSource = "<?php echo Yii::app()->baseUrl;?>/css/piecemaker.css";
  flashvars.xmlSource = "<?php echo Yii::app()->baseUrl;?>/piecemaker.php?path=<?php echo Yii::app()->baseUrl;?>";
  ...
  swfobject.embedSWF('<?php echo Yii::app()->baseUrl;?>/piecemaker.swf', 'piecemaker', '960', '430', '10', null, flashvars,    
  params, null);
